			...
			<h3 class="form-signin-heading"><i class="icon-lock"></i> Register as Student</h3>
			...
			<button id="signin" name="login" class="btn btn-info" type="submit"><i class="icon-check icon-large"></i> Register </button>
			</form>
			...
			jQuery("#signin_student").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to Bright Technological University Learning Management System", { header: 'Sign up Success' });
						var delay = 2000;
